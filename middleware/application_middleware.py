...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_2b45f45628a947eba9b1a00c4ef4274e
    """
    try:
        ...
        auth_package_secret_key = """Oh224Kle6dI3R_GvKHbcCV9dpis-zKIum5euj6vibtU="""
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_b19fcd555ba24b88b467f673ea6b3ba2
    """
    try:
