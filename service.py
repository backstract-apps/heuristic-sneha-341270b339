...
async def post_notes(
    ...
    gradient_preset: str = raw_data.gradient_preset
    created_at_dt: str = convert_to_datetime(raw_data.created_at_dt)
...
async def post_platform_auth_package_mayson_auth_user_login(
    ...
    secret_key = """Oh224Kle6dI3R_GvKHbcCV9dpis-zKIum5euj6vibtU="""
    bs_jwt_payload = {
    ...
    try:
        ...
        async def google_login():
            async with httpx.AsyncClient() as client:
                headers = {
                    "Authorization": "Bearer v4.public.-XQPiT59r6laKWxW11-a0ZpDma_K0Z3tOD6w__V2egizo17QI",
                    "Content-Type": "application/json",
                }

                res = await client.get(
                    "https://api-release.beemerbenzbentley.site/sigma/api/v1/sso/auth/google/login?collection_id=coll_ef7fa097f692475a949b209099acc03f",
                    headers=headers,
                )
